...
/*
Package pbsrvuser is a reverse proxy.
...
var (
	filter_UserService_ListFavourites_0 = &utilities.DoubleArray{Encoding: map[string]int{"id_user": 0, "key": 1}, Base: []int{1, 2, 3, 2, 0, 0}, Check: []int{0, 1, 1, 2, 4, 3}}
)
...
func request_UserService_ListFavourites_0(ctx context.Context, marshaler runtime.Marshaler, client UserServiceClient, req *http.Request, pathParams map[string]string) (UserService_ListFavouritesClient, runtime.ServerMetadata, error) {
	var protoReq ListFavouritesRequest
	var metadata runtime.ServerMetadata
...
var (
	filter_UserService_ListOpinions_0 = &utilities.DoubleArray{Encoding: map[string]int{"id_user": 0, "key": 1}, Base: []int{1, 2, 3, 2, 0, 0}, Check: []int{0, 1, 1, 2, 4, 3}}
)
...
func request_UserService_ListOpinions_0(ctx context.Context, marshaler runtime.Marshaler, client UserServiceClient, req *http.Request, pathParams map[string]string) (UserService_ListOpinionsClient, runtime.ServerMetadata, error) {
	var protoReq ListOpinionsRequest
	var metadata runtime.ServerMetadata
...
func RegisterUserServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client UserServiceClient) error {
	...
	mux.Handle("GET", pattern_UserService_ListFavourites_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/proto.serv._user.v1.UserService/ListFavourites", runtime.WithHTTPPathPattern("/api/v1/favourite/list/user/{id_user.key}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_UserService_ListOpinions_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/proto.serv._user.v1.UserService/ListOpinions", runtime.WithHTTPPathPattern("/api/v1/opinion/list/user/{id_user.key}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	...
	pattern_UserService_ListFavourites_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 1, 0, 4, 1, 5, 5}, []string{"api", "v1", "favourite", "list", "user", "id_user.key"}, ""))

	pattern_UserService_ListOpinions_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 1, 0, 4, 1, 5, 5}, []string{"api", "v1", "opinion", "list", "user", "id_user.key"}, ""))
)

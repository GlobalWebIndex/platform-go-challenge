...
const (
	AssetService_Create_FullMethodName = "/proto.serv.asset.v1.AssetService/Create"
	AssetService_Get_FullMethodName    = "/proto.serv.asset.v1.AssetService/Get"
	AssetService_Gett_FullMethodName   = "/proto.serv.asset.v1.AssetService/Gett"
	AssetService_Update_FullMethodName = "/proto.serv.asset.v1.AssetService/Update"
	AssetService_Delete_FullMethodName = "/proto.serv.asset.v1.AssetService/Delete"
)
...
func (c *assetServiceClient) Gett(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	out := new(GetResponse)
...
func (UnimplementedAssetServiceServer) Gett(context.Context, *GetRequest) (*GetResponse, error) {
...
func _AssetService_Gett_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AssetServiceServer).Gett(ctx, req.(*GetRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AssetService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "proto.serv.asset.v1.AssetService",
	...
	Metadata: "proto/serv/asset/v1/asset_srv.proto",
}
